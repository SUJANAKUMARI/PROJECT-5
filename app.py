...
url = 'https://drive.google.com/file/d/1xw90oufaqbE1y8gOZrx3wgJMnJZvxkwN/view?usp=drive_link'
...
# Define User Overview Analysis page
    ...
    gradient_descent_model = joblib.load('gradient_descent_model.joblib')  # Use consistent variable name
    ...
    if st.button("Predict Satisfaction and Cluster"):
        ...
        satisfaction_score = gradient_descent_model.predict(features)  # Correctly using the loaded variable name
